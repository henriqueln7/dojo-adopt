...
class AnimalRepositoryTest {
    ...
    class MonthlyExpensesByOwner {
        ...
        void should_return_average_monthly_expenses_by_owner_correctly() {
            ...
            Owner caio = OwnerBuilder.anOwner().withName("Caio").build();
            ...
            assertThat(animalRepository.monthlyExpensesByOwner()).extracting("ownerName", "monthlyTotalExpenses").containsExactly(
                    tuple("Gabriel", new BigDecimal("300.00")),
                    tuple("Maria", new BigDecimal("200.00")),
                    tuple("Caio", new BigDecimal("150.00")),
                    tuple("Rômulo", new BigDecimal("0")));
        }
    }
